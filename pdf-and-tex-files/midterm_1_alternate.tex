...
\newpage
\question[10] Let $n$ be a positive integer such that $n^2$ has exactly three positive prime divisors. Prove that $n$ is the square of a prime number.  
...
\newpage
\question[10] Congruences computation. Let $a, b \in \mathbb{Z}$ and $n \in \mathbb{Z}_{>0}$. Prove or disprove the following statements about congruences modulo $n$. 
\begin{parts}
    \part Compute $(3^{47} - 25)\%28$, that is, find the integer $x$ with $0 \leq x < 28$ such that $3^{47} - 25 \equiv x \pmod{22}$. 
    \vfill 
